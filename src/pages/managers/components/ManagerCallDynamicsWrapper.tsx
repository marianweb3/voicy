...
import { useManagerDynamics } from "../../../hooks/useManagers";
import { Dropdown } from "../../../components/ui/dropdown";
import CallDynamicsChart from "../../dashboard/components/CallDynamicsChart";
...
interface ManagerCallDynamicsWrapperProps {
  title?: string;
...
const ManagerCallDynamicsWrapper = ({
  ...
  showPeriodTabs = true,
  className = "",
}: ManagerCallDynamicsWrapperProps) => {
  ...
  const {
    ...
    timeUpdate,
  } = useManagerDynamics(managerId, selectedRange, selectedType);
      ...
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            {timeUpdate && (
              <p className="text-[#666] text-sm">Статус: {timeUpdate}</p>
            )}
          </div>
          {showDropdown && (
            <Dropdown
...
export default ManagerCallDynamicsWrapper;
